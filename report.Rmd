...
The source files are posted at [https://github.com/pedrosan/DSCP1](https://github.com/pedrosan/DSCP1)
...
In particular I am leaning towards a _weighted combination_ of _1- 2- 3- 4-grams_ (linear
...
(`redByLine()`) (see Appendix for the short source).
...
```
```{r load_cleaned_data, eval = TRUE, cache = FALSE, echo = FALSE}
# NOT ECHOED
...
```{r sentence_annotation-read, eval = TRUE, cache = FALSE, echo = FALSE}
# NOT ECHOED
...
```{r top20_n4grams, eval = TRUE, cache = TRUE}
print(cbind(head(n4g.blogs.freq, 20), head(n4g.news.freq, 20), head(n4g.twitter.freq, 20)), 
      print.gap = 3, right = FALSE)
```
